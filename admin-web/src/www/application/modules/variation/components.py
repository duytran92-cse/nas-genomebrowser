...
class VariationStore(object):
    ...
    def list(self, params={}, sortkey='id', sortdir='desc', page_number=1):
        ...
        return data['data']
    def get(self, id):
        return self.container.call_api(settings.GENOME_BROWSER_API_URL + '/variation/get', GET={'id': id})
    def create(self, data):
        return self.container.call_api(settings.GENOME_BROWSER_API_URL + '/variation/create', POST=data)
    def update(self, data, id):
        data['id'] = id
        return self.container.call_api(settings.GENOME_BROWSER_API_URL + '/variation/update', POST=data)
    def delete(self, id):
        return self.container.call_api(settings.GENOME_BROWSER_API_URL + '/variation/delete', POST={'id': id})
    def populate_combobox(self, kind=''):
        ...
        records = self.container.call_api(settings.GENOME_BROWSER_API_URL + '/variation/list', GET=params)
        ...
        return choices
    def summary(self, id):
        return self.container.call_api(settings.GENOME_BROWSER_API_URL + '/variation/summary', GET={'variation_id': id})
