...
GENOME_BROWSER_API_URL = 'http://%s:%s' % (os.environ.get('GENOME_BROWSER_API_HOST'), os.environ.get('GENOME_BROWSER_API_PORT'))

NOTASQUARE_SEQUENCE_URL = 'http://sequence-viewer-front.gp.test.notasquare.vn'
GENEBAY_FRONTEND_URL = 'http://genebay-front.gp.test.notasquare.vn/genebay'
GENOPEDIA_USER_URL = 'http://user-front.gp.test.notasquare.vn'
GENOPEDIA_SEQUENCE_VIEWER_URL = 'http://sequence-viewer-api.gp.test.notasquare.vn'
GENOPEDIA_USER_API_URL = 'http://%s:%s' % (os.environ['USER_API_HOST'], os.environ['USER_API_PORT'])
