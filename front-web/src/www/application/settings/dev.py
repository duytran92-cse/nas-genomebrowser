...
ALLOWED_HOSTS = ['genome-browser-front.genopedia.local']
...
MIDDLEWARE_CLASSES = [
    ...
    'application.modules.common.middleware.LanguageMiddleware'
]
...
LOCALE_PATH = (os.path.join(BASE_DIR, u'locale'))

GENOME_BROWSER_API_URL = 'http://%s:%s' % (os.environ['GENOME_BROWSER_API_PORT_80_TCP_ADDR'], os.environ['GENOME_BROWSER_API_PORT_80_TCP_PORT'])
NOTASQUARE_SEQUENCE_URL = 'http://sequence-viewer-front.genopedia.local'
GENEBAY_FRONTEND_URL = 'http://genebay-front.genopedia.local/genebay'
GENOPEDIA_USER_URL = 'http://user-front.genopedia.local'
GENOPEDIA_USER_API_URL = 'http://user-front.genopedia.local'
GENOPEDIA_SEQUENCE_VIEWER_URL = 'http://sequence-viewer-api.genopedia.local'
